...
import { p as parseURL, e as encodePath, m as decodePath, n as hasProtocol, o as isScriptProtocol, l as joinURL, w as withQuery, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as defu, i as createError$1, x as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-UmTG71GS.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BRztwP7-.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C8d5C-7k.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DUPeWK3L.mjs'));
