...
const styles = {
  ...
  "components/AppFooter.vue": () => import('./AppFooter-styles.D1cV2Yg5.mjs').then(interopDefault),
  "components/AppFooter.vue?vue&type=style&index=0&scope=true&lang.css": () => import('./AppFooter-styles.D1cV2Yg5.mjs').then(interopDefault)
};
